...
import 'package:mung_gym/foodDrive/foodDrive4.dart';

class Fooddrive3 extends StatefulWidget {
  final String name;
  ...
  @override
  State<Fooddrive3> createState() => _Fooddrive3State();
}

class _Fooddrive3State extends State<Fooddrive3> {
  // 선택 가능한 항목들
  final List<String> foodDrive1Options = ['낯선 사람이 주는', '익숙하고 편한 사람이 주는'];
