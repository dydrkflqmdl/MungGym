...
import 'package:mung_gym/foodDrive/foodDrive5.dart';

class Fooddrive4 extends StatefulWidget {
  final String name;
  ...
  @override
  State<Fooddrive4> createState() => _Fooddrive4State();
}

class _Fooddrive4State extends State<Fooddrive4> {
  // 선택 가능한 항목들
  final List<String> foodDrive1Options = ['처음 먹어보는 간식을', '먹어봤던 간식을'];
